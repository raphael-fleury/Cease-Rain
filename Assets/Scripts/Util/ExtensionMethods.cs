...
public static class ExtensionMethods
{
    ...
    #region Mathf
    public static int Biggest(params int[] args)
    {
        int biggest = args[0];
    ...
    public static float Biggest(params float[] args)
    {
        float biggest = args[0];
    ...
    public static int Smallest(params int[] args)
    {
        int smallest = args[0];
        foreach (int i in args)
        {
    ...
    public static float Smallest(params float[] args)
    {
        float smallest = args[0];
        foreach (float f in args)
        {
            if (f < smallest)
                smallest = f;
